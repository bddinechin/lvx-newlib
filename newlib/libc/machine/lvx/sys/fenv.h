...
/*
 *  This file provides sys/fenv.h for the LVX processor.
 */
 ...
 *
 * LVX-1 is a simplification of KVX's kv4-1 variant, so it reuses the kv4-1
 * rounding mode encoding below (the alternate kv3 encoding from the KVX
 * source of this file has been dropped, since LVX has no kv3 lineage).
 *
...
#define _FE_TOWARDZERO 1
#define _FE_DOWNWARD   2
#define _FE_UPWARD     3

#define _FE_X_TONEAREST  0
#define _FE_X_TOWARDZERO 1
#define _FE_X_DOWNWARD   2
#define _FE_X_UPWARD     3
