    ...
    if (__builtin_expect(nan_or_inf, 0)) {
        ...
        if (__builtin_expect(tmp, 0)) {
            ...
            if (__builtin_expect(tmp0, 0)) {
                ...
                ik = __builtin_lvx_fixedw(unround_k, 0, ".rn");
                late_overflow_test = ik > INT32_C(127);
                carg = __builtin_lvx_fixedw(unround_k, 0, ".rn");
                k = __builtin_lvx_floatw(carg, 0, ".rn");
                ...
                if (__builtin_expect(tmp2, 1)) {
                    ...
                    exact_hi = __builtin_lvx_ffmsw(k, 0x1.62ep-1f, x, "");
                    tmp3 =  - k;
                    exact_lo = tmp3 * 0x1.0bfbe8p-15f;
                    exact_hi1 = __builtin_lvx_ffmsw(k, 0x1.62ep-1f, x, "");
                    r = exact_hi1 + exact_lo;
                    r2_ = r * r;
                    tmp4 = 0x1.55548cp-3f * r2_;
                    tmp5 = r * tmp4;
                    tmp6 = __builtin_lvx_ffmaw(0x1p-1f, r2_, tmp5, "");
                    tmp7 = 0x1.5554cep-5f * r2_;
                    tmp8 = __builtin_lvx_ffmaw(r2_, tmp7, tmp6, "");
                    tmp9 = 0x1.6d6748p-10f * r2_;
                    tmp10 = r * tmp9;
                    tmp11 = __builtin_lvx_ffmaw(0x1.123d02p-7f, r2_, tmp10, "");
                    r3_ = r * r2_;
                    pre_sub_poly = __builtin_lvx_ffmaw(r3_, tmp11, tmp8, "");
