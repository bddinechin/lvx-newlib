...
int fesetenv(const fenv_t *envp)
{
   ...
   * bit-fields of $cs), with 'fe << 32' as a set mask and
   * FE_ALL_EXCEPT|FE_RND_MASK as a clear mask.
   */
  asm volatile ("wfxl $cs, %0" : : "r"(((long long)fe << 32) | FE_ALL_EXCEPT | FE_RND_MASK) : "$cs");
